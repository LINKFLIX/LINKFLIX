...
- **Link**와 **Netflix**의 합성어로 넷플릭스와 연결된 서비스임을 의미    
...
- 영상 속 상품이 나오는 시간을 **타임라인**에 표시하여 해당 상품을 바로 찾아볼 수 있습니다.

### :four: 실시간 가격 비교된 최저가 쇼핑몰로 연결!  
<img src="/md-images/linkflix2.gif" width="100%" alt="linkflix1"></img><br/>  
- **실시간으로 가격 비교된 쇼핑몰**을 확인할 수 있습니다.  
- 가격 순으로 보여지며, 원하는 쇼핑몰을 클릭하면 해당 홈페이지로 **바로 이동**합니다.  
